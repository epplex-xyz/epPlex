use crate::*;
use anchor_spl::{token_2022::spl_token_2022::extension::BaseStateWithExtensions, token_interface::spl_token_metadata_interface::borsh::BorshDeserialize};
...
pub fn fetch_metadata_field(field: &str, mint_account: &AccountInfo) -> Result<String> {
    ...
    // Fetch the expiry date
    {
        ...
        let state =
            anchor_spl::token_2022::spl_token_2022::extension::StateWithExtensions::<anchor_spl::token_2022::spl_token_2022::state::Mint>::unpack(
                &mint_data,
            )?;
